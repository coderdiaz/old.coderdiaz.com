...
export const GetaQuote = () => {
  ...
  return (
    <div className="flex items-center gap-2">
      <button onClick={handleQuoteOpen} className="border-2 flex items-center gap-2.5 border-black font-medium w-max text-black rounded-xl text-sm px-4 py-2 bg-white transition-all duration-300 hover:ring-4 hover:ring-[#FFA36F40]">
        Cotizar
      </button>
